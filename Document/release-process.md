...
### Educoin Core maintainers/release engineers, suggestion for writing release notes
...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in educoin, then:
...
### Build and sign Educoin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit educoin=v${VERSION} ../educoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit educoin=v${VERSION} ../educoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit educoin=v${VERSION} ../educoin/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer educoin-osx-unsigned.tar.gz to osx for signing
    tar xf educoin-osx-unsigned.tar.gz
...
Codesigner only: Sign the windows binaries:
    ...
    tar xf educoin-win-unsigned.tar.gz
